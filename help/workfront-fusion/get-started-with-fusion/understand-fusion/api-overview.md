---
title: Información general sobre la API
...
>[!NOTE]
>
>Workfront Fusion tiene su propia API que puede utilizar para automatizar acciones en Fusion.
...
>Para obtener documentación sobre la API de Workfront Fusion, consulte [API de Workfront Fusion](https://developer.adobe.com/workfront-fusion-apis/).

## Consideraciones

El hecho de que las API estén definidas por sus propietarios y no por Fusion lleva a algunas consideraciones importantes:

* **Puede utilizar Fusion para conectarse a cualquier aplicación o servicio que tenga una API pública**, independientemente de si Fusion ofrece o no un conector dedicado a esa aplicación o servicio. Puede utilizar los conectores universales de Fusion para incorporar estas aplicaciones o servicios a sus escenarios.
...
* **Los cambios realizados por su propietario en la API de una aplicación pueden afectar a la funcionalidad de Fusion.** Si los cambios son lo suficientemente graves, Fusion puede necesitar actualizar módulos o tipos de conexión, o en casos extremos puede crear un nuevo conector para la aplicación.
...
* Si los cambios estaban relacionados con la autenticación o la autorización, es posible que tenga que actualizar las conexiones de esa aplicación.
...
Para obtener información e instrucciones sobre cómo actualizar un módulo, consulte [Actualizar un módulo a una nueva versión](/help/workfront-fusion/manage-scenarios/update-module-to-new-version.md).
