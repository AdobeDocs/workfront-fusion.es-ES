...
title: Administrar escenarios desde el área de Escenarios
...
# Administrar escenarios desde el área de Escenarios

En el área Escenarios, puede ver información sobre los escenarios propiedad de un equipo. También puede clonar, mover o eliminar escenarios, o asignarlos a un grupo de trabajo específico.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Debe ser administrador de Fusion para asignar un escenario a un grupo de trabajo. </td>
   </tr>
 </tbody> 
</table>
...
## Ver y administrar escenarios desde el área Escenarios
...
1. Para mover uno o más escenarios a una carpeta, haga clic en la casilla de verificación situada junto a cada escenario que desee mover y, a continuación, haga clic en **Mover a carpeta** en la barra situada en la parte inferior de la pantalla. En la ventana que aparece, seleccione la carpeta a la que desee mover los escenarios y, a continuación, haga clic en **Mover**.
