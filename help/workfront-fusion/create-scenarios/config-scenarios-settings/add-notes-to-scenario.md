...
1. Arrastre la nota a la ubicación deseada en el Editor de escenarios.
   ...
   Después de agregar una nota a un escenario, aparece un punto azul en el icono **[!UICONTROL Notes]** ![Icono de notas con punto](assets/notes-icon-w-dot.png) en la parte inferior del editor de escenarios.

1. Para ver u ocultar todas las notas, haga clic en el icono **[!UICONTROL Notes]** icono ![Notas con punto](assets/notes-icon-w-dot.png).
