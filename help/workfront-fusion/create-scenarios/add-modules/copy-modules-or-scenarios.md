...
>[!NOTE]
>
>En lugar de copiar un grupo de módulos, puede mover un grupo de módulos a un nuevo escenario encadenado. Para obtener instrucciones, vea [Mover módulos a una cadena](/help/workfront-fusion/manage-scenarios/move-modules-to-a-chain.md).
