---
title: Actividad de la versión de Workfront Fusion Semana del 18 de agosto de 2025
description: Actividad de la versión de Workfront Fusion Semana del 18 de agosto de 2025
author: Becky
...
Para facilitar la depuración o el uso compartido de la configuración de módulos, hemos hecho posible crear un vínculo a un módulo específico en un escenario.Para crear un vínculo a un módulo específico, agregue `?moduleId=<module-id>` a la dirección URL cuando visualice las siguientes páginas:
