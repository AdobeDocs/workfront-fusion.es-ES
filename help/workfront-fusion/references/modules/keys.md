...
Puede actualizar una clave existente. Cuando se actualiza la clave, todos los escenarios que utilicen la clave utilizarán la clave actualizada.

1. En Fusion, haga clic en el icono de claves ![Keys](assets/keys-icon.png) en el panel de navegación izquierdo.
1. Seleccione la tecla que desee editar y, a continuación, haga clic en Editar en la barra de la parte inferior de la pantalla.
1. Edite la clave como desee.
