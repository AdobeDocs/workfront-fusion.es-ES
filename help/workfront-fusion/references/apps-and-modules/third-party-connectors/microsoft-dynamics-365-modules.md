   ...
   <table style="table-layout:auto"> 
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Introduzca su [!UICONTROL Client ID] [!DNL Microsoft Dynamics].</td>
        </tr>
        <tr>
  ...
  <tr> 
   ...
   <td> <p>Seleccione el webhook que desee utilizar para este módulo. </p> <p>Para añadir un nuevo webhook:</p> 
    <ol> 
     ...
     <li value="3"> <p>En el campo <strong>[!UICONTROL Conexión]</strong>, seleccione la Conexión que desea utilizar.</p> <p>Para obtener instrucciones sobre cómo conectar su cuenta de [!DNL Microsoft Dynamics 365] a Workfront Fusion, consulte <a href="#connect-microsoft-dynamics-365-to-workfront-fusion" class="MCXref xref">Conexión de [!DNL Microsoft Dynamics 365] a Workfront Fusion</a> en este artículo. </p> </li> 
...
* [[!UICONTROL Eliminación de registro]](#delete-record)
...
Este módulo de acción le permite realizar una llamada autenticada personalizada a la API [!DNL Microsoft Dynamics 365]. De este modo, puede crear una automatización del flujo de datos imposibles de realizar por los otros [!DNL Microsoft Dynamics 365] módulos.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Seleccione el método de petición HTTP que necesita para configurar la llamada de la API. Para obtener más información, consulte <a href="/help/workfront-fusion/references/modules/http-request-methods.md" class="MCXref xref" data-mc-variable-override="">Métodos de petición HTTP</a>.</p> <p>Para obtener más</p> </td> 
  </tr> 
  <tr> 
