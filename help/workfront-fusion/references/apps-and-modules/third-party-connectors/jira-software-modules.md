...
## Conexión de [!DNL Jira Software] a Workfront Fusion
...
1. En cualquier módulo de [!DNL Jira Server] en Workfront Fusion, haga clic en **[!UICONTROL Agregar]** junto al campo [!UICONTROL conexión].
