...
Para usar módulos [!DNL MariaDB], debe tener una cuenta de [!DNL MariaDB].
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>Para obtener instrucciones sobre cómo conectar su cuenta de [!DNL MariaDB] a Workfront Fusion, consulte <a href="#connect-mariadb-to-workfront-fusion" class="MCXref xref">Conexión de [!DNL MariaDB] a Workfront Fusion</a> en este artículo.</td> 
  </tr> 
  <tr> 
