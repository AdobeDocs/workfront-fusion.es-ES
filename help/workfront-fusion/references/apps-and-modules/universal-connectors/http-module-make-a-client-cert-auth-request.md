---
title: Módulo HTTP > Realizar una solicitud de autorización de certificado de cliente
description: Este módulo de  [!DNL Adobe Workfront Fusion]  permite configurar una petición HTTP con autorización de certificado de cliente HTTP y enviarla a un servidor. La respuesta HTTP recibida se incluye entonces en el paquete de salida.
author: Becky
...
# Módulo HTTP > [!UICONTROL Make a Client Certificate Authorization request]

>[!NOTE]
>
>Adobe Workfront Fusion requiere una licencia de [!DNL Adobe Workfront Fusion] además de una licencia Adobe Workfront.

Este módulo de [!DNL Adobe Workfront Fusion] permite configurar una petición HTTP con autorización de certificado de cliente HTTP y enviarla a un servidor. La respuesta HTTP recibida se incluye entonces en el paquete de salida.
...
## [!UICONTROL HTTP] >[!UICONTROL Make a Client Certificate Authorization request] configuración del módulo

Al configurar el módulo [!UICONTROL HTTP] >[!UICONTROL Make a Client Certificate Authorization request], [!DNL Adobe Workfront Fusion] muestra los campos que se indican a continuación. El título en negrita en un módulo indica un campo obligatorio.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Seleccione la clave que contiene las credenciales de autenticación de certificado de cliente o haga clic en <strong>[!UICONTROL Add]</strong> para agregar las credenciales a una clave nueva. </p> <p>Nota: Se pueden añadir más credenciales para cambiar fácilmente entre cada conexión.</p> </td> 
  </tr> 
  <tr> 
